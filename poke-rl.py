...
if __name__ == "__main__":
    opponent = RandomPlayer(account_configuration=AccountConfiguration(username="randRoberto"))
    env_player = SimpleRLPlayer(account_configuration=AccountConfiguration(username="RLPVaporeon"), opponent=opponent)
    second_opponent = MaxDamagePlayer(account_configuration=AccountConfiguration(username="MaxDamAAA"))
